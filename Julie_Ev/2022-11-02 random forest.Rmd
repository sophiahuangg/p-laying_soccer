...
```{r}
fivefeatures <- read_csv("C:/Users/juye/p-ai/p-laying_soccer/R/Julie/fivefeatures_euro2022.csv", 
...
anjali_sophia <- read_csv("C:/Users/juye/p-ai/p-laying_soccer/R/Julie/anjali_sophia_features.csv", 
...
teamnames <-
  ...
  distinct() %>%
  arrange(team.id) %>%
  dplyr::rename(team_name = team.name)
teamnames
```

```{r}
# write.csv(fivefeatures,"C:/Users/juye/p-ai/p-laying_soccer/R/Julie/teamnameids.csv", row.names = FALSE)
```


```{r}
aser_mohamed <- read_csv("C:/Users/juye/p-ai/p-laying_soccer/R/Julie/aser_mohamed_features.csv", 
...
```{r}
# write.csv(combinedfeatures, "C:/Users/juye/p-ai/p-laying_soccer/R/Julie/combinedfeatures.csv", row.names = FALSE)
```
